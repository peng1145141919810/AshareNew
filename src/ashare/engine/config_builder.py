...
def build_runtime_config() -> Dict[str, Any]:
    ...
    cfg: Dict[str, Any] = {
        ...
        "portfolio_recommendation": {
            ...
            "enable_intelligent_outer_allocator": bool(getattr(LS, "PORTFOLIO_ENABLE_INTELLIGENT_OUTER_ALLOCATOR", True)),
            "intelligent_outer_allocator_replaces_internal_gates": bool(getattr(LS, "PORTFOLIO_INTELLIGENT_OUTER_ALLOCATOR_REPLACES_INTERNAL_GATES", True)),
        ...
        "portfolio_candidate_llm_review": {
            "enabled": bool(getattr(LS, "ENABLE_PORTFOLIO_CANDIDATE_LLM_REVIEW", True)),
        ...
        "strategy_activation": {
            ...
            "llm_enabled": bool(getattr(LS, "ENABLE_STRATEGY_ACTIVATION_LLM", True)),
        ...
        "trade_clock": {
            ...
            "runtime_hot_reload": {
                "enabled": bool(getattr(LS, "TRADE_CLOCK_RUNTIME_HOT_RELOAD_ENABLED", True)),
            ...
            "scheduler": {
                ...
                "research_refresh_profile": str(getattr(LS, "TRADE_CLOCK_RESEARCH_REFRESH_PROFILE", "quick_test") or "quick_test"),
